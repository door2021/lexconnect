        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "handle",
                    models.CharField(
                        help_text="Public @handle used in your profile URL.",
                        max_length=30,
                        unique=True,
                        validators=[apps.accounts.validators.validate_handle],
                        verbose_name="handle",
                    ),
                ),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            ("handle", django.db.models.functions.text.Lower("handle"))
                        ),
